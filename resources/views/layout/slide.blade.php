        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="@yield('pegawai')">
                    <a href="{{ url('/pegawai') }}"> <i class="menu-icon fa fa-users"></i>Daftar Divisi</a>
                </li>
                ...
                <li class="@yield('approval')">
                    <a href="{{ url('/approvals') }}"> <i class="menu-icon fa fa-check-circle"></i>Daftar Approval</a>
                </li>
