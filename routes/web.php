...
Route::middleware(['user'])->group(function () {
    ...
    Route::patch('/approvals/approve/{id}', [ApprovalController::class, 'approve'])->name('approvals.approve');
    Route::patch('/approvals/reject/{id}', [ApprovalController::class, 'reject'])->name('approvals.reject');
    Route::delete('/approvals/{id}', [ApprovalController::class, 'destroy'])->name('approvals.destroy');
